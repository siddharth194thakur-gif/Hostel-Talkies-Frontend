    ...
    <article className="bg-white rounded-3xl border border-slate-200/80 card-3d-luxury overflow-hidden flex flex-col justify-between group animate-fade-in-up">
      ...
      <div className="px-4 sm:px-5 py-3 bg-slate-50/70 border-t border-slate-150 flex items-center justify-between text-slate-500 text-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to={`/posts/${post.id}`}
            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-bold transition text-xs shadow-xs hover:shadow-badge active:scale-95 cursor-pointer"
          >
            <span>View Deal</span>
